...
public class CorrectPointRepo {
    ...
    private final String insertSQL = "INSERT INTO CorrectPoint (questionID, phrase, marksWorth, feedback) values (:questionID, :phrase, :marksWorth, :feedback)";
    private final String updateSQL = "UPDATE CorrectPoint SET questionID=:questionID, phrase=:phrase, marksWorth=:marksWorth, feedback=:feedback WHERE correctPointID=:correctPointID";
