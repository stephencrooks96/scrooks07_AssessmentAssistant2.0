...
public class CorrectPointRepo {
    ...
    private final String insertSQL = "INSERT INTO CorrectPoint (questionID, phrase, marksWorth, feedback, index) values (:questionID, :phrase, :marksWorth, :feedback, :index)";
    private final String updateSQL = "UPDATE CorrectPoint SET questionID=:questionID, phrase=:phrase, marksWorth=:marksWorth, feedback=:feedback, index=:index WHERE correctPointID=:correctPointID";
