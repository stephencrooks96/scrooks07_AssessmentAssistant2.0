...
public class TestTestsRepo {
	...
	public void testRowCount() {
		...
		int rowCountBefore = testRepo.rowCount().intValue();

		// Inserts one test to table
		testRepo.insert(test);

		// Checks one value is registered as in the table
		assertTrue(testRepo.rowCount().intValue() > rowCountBefore);
	...
	/**
	 * Test method for
	 * {@link pgault04.repositories.TestsRepo#selectByLastName(java.lang.String)}.
	 */
	@Test
