...
/*
 * This is a useful shorthand when the only optionContent you need is "cause".
 */
...
The third form is equivalent to using the first form with all default optionContent
...
the `info` optionContent to the constructor.  Properties not specified in the
