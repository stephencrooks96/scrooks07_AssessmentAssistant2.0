...
When `json` optionContent is enabled and `JSON.parse` fails.
...
You can use the [`tunnel`](https://github.com/koichik/node-tunnel) module with the `agent` optionContent to work with proxies:
