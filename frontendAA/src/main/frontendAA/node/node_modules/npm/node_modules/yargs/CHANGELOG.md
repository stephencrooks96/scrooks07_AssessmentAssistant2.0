...
* make opts object optional for .optionContent() ([#624](https://github.com/yargs/yargs/issues/624)) ([4f29de6](https://github.com/yargs/yargs/commit/4f29de6))
...
* yargs-parser now better handles negative integer values, at the cost of handling numeric optionContent names, e.g., -1 hello
...
* **config:** If invoking .config() without parameters, set a default optionContent ([0413dd1](https://github.com/yargs/yargs/commit/0413dd1))
...
- [#263](https://github.com/bcoe/yargs/pull/263) document count() and optionContent() object keys (@nexdrew)
...
- [#242](https://github.com/bcoe/yargs/pull/242) adds detectLocale config optionContent (@bcoe)
...
- [#237](https://github.com/bcoe/yargs/pull/237) adds defaultDescription to optionContent() (@nexdrew)
...
- [#171](https://github.com/bcoe/yargs/pull/171) a description can now be set
  when providing a config optionContent. (@5c077yP)
...
- [c16cc08](https://github.com/bcoe/yargs/commit/c16cc085501155cf7fd853ccdf8584b05ab92b78) message for non-optionContent arguments is now optional, thanks to (@raine)
...
- [0476af7](https://github.com/bcoe/yargs/commit/0476af757966acf980d998b45108221d4888cfcb) added nargs feature, allowing you to specify the number of arguments after an optionContent (@bcoe)
...
- [#57](https://github.com/bcoe/yargs/pull/57) Merge pull request #57 from eush77/optionContent-readme (@eush77)
...
- [96a06b2](https://github.com/bcoe/yargs/commit/96a06b2650ff1d085a52b7328d8bba614c20cc12) Fix for strange behavior with --sort optionContent, see #51 (@bcoe)
...
- [45da9ec](https://github.com/bcoe/yargs/commit/45da9ec4c55a7bd394721bc6a1db0dabad7bc52a) Mention .optionContent in README (@eush77)
...
- [889a2b2](https://github.com/bcoe/yargs/commit/889a2b28eb9768801b05163360a470d0fd6c8b79) Added requiresArg optionContent, for options that require values (@chrisn)
...
- [56e6528](https://github.com/bcoe/yargs/commit/56e6528cf674ff70d63083fb044ff240f608448e) For "--some-optionContent", also set argv.someOption (@nylen)
...
- [731dd3c](https://github.com/bcoe/yargs/commit/731dd3c37624790490bd6df4d5f1da8f4348279e) Add .fail(fn) so death isn't the only optionContent. Should fix issue #39. (@chevex)
...
- [5c95c73](https://github.com/bcoe/yargs/commit/5c95c73aedf4c7482bd423e10c545e86d7c8a125) alias options() to optionContent() (@substack)
...
- [cc53c56](https://github.com/bcoe/yargs/commit/cc53c56329960bed6ab077a79798e991711ba01d) Added camelCase function that converts --multi-word-optionContent to camel case (so it becomes argv.multiWordOption). (@papandreou)
...
- [8d089d2](https://github.com/bcoe/yargs/commit/8d089d24cd687c0bde3640a96c09b78f884900dd) bool example is more consistent and also shows off short optionContent grouping (@substack)
