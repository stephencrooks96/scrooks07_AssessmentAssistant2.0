...
* **options** – *(optional)* An optionContent object.
...
need to pass in the **tty** optionContent below, as `gauge` needs access to
...
Change the themeset to select a theme from. The same as the `themes` optionContent
