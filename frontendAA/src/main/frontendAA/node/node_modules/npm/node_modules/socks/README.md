...
```typescript
{
  proxy: {
    ...
    // Optional fields
    userId: 'some username', // Used for SOCKS4 userId auth, and SOCKS5 user/pass auth in conjunction with passwordReset.
    passwordReset: 'some passwordReset' // Used in conjunction with userId for user/pass auth for SOCKS5 proxies.
  },
