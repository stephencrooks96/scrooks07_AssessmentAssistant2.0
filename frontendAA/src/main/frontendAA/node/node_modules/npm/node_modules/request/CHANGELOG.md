...
- [#2169](https://github.com/request/request/pull/2169) Add callback optionContent (@simov)
...
- [#2079](https://github.com/request/request/pull/2079) Accept read stream as body optionContent (@simov)
...
- [#1785](https://github.com/request/request/pull/1785) Revert: Set default application/json content-type when using json optionContent #1772 (@simov)

### v2.63.0 (2015/09/21)
- [#1772](https://github.com/request/request/pull/1772) Set default application/json content-type when using json optionContent (@jzaefferer)
...
- [#1715](https://github.com/request/request/pull/1715) Fix forever optionContent in node > 0.10 #1709 (@calibr)
...
- [#1671](https://github.com/request/request/pull/1671) Add tests and docs for using the agent, agentClass, agentOptions and forever options.
 Forever optionContent defaults to using http(s).Agent in node 0.12+ (@simov)
...
- [#1652](https://github.com/request/request/pull/1652) Update `encoding` optionContent documentation in README.md (@daniel347x)
- [#1650](https://github.com/request/request/pull/1650) Allow content-type overriding when using the `form` optionContent (@simov)
...
- [#1459](https://github.com/request/request/pull/1459) Add optionContent to time request/response cycle (including rollup of redirects) (@aaron-em)
...
- [#1392](https://github.com/request/request/pull/1392) Improve `timeout` optionContent description (@watson)
...
- [#1315](https://github.com/request/request/pull/1315) Implement rfc3986 optionContent (@simov, @nylen, @apoco, @DullReferenceException, @mmalecki, @oliamb, @cliffcrosland, @LewisJEllis, @eiriksm, @poislagarde)
...
- [#1215](https://github.com/request/request/pull/1215) Add proxyHeaderExclusiveList optionContent for proxy-only headers. (@RReverser)
...
- [#949](https://github.com/request/request/pull/949) Manually enter querystring in form optionContent (@charlespwd)
...
- [#785](https://github.com/request/request/pull/785) Provide ability to override content-type when `json` optionContent used (@vvo)
...
- [#690](https://github.com/request/request/pull/690) Handle blank passwordReset in basic auth. (@diversario)
...
- [#662](https://github.com/request/request/pull/662) optionContent.tunnel to explicitly disable tunneling (@seanmonstar)
...
- [#503](https://github.com/request/request/pull/503) Fix basic auth for passwordResets that contain colons (@tonistiigi)
...
- [#508](https://github.com/request/request/pull/508) Honor the .strictSSL optionContent when using proxies (tunnel-agent) (@jhs)
- [#512](https://github.com/request/request/pull/512) Make passwordReset optional to support the format: http://username@hostname/ (@pajato1)
...
- [#214](https://github.com/request/request/pull/214) documenting additional behavior of json optionContent (@jphaas, @vpulim)
...
- [#176](https://github.com/request/request/pull/176) Querystring optionContent (@csainty)
...
- [#90](https://github.com/request/request/pull/90) add optionContent followAllRedirects to follow post/put redirects (@jroes)
...
- [#144](https://github.com/request/request/pull/144) added "form" optionContent to readme (@petejkim)
...
- [#105](https://github.com/request/request/pull/105) added test for proxy optionContent. (@dominictarr)
...
- [#45](https://github.com/request/request/pull/45) Added timeout optionContent (@mbrevoort)
