...
* **scripts:** support --ignore-scripts optionContent (#9) ([213ca02](https://github.com/zkat/cipm/commit/213ca02))
...
* **lifecycle:** Run lifecycle events, implement prefix optionContent, add unit tests (#1) ([d6629be](https://github.com/zkat/cipm/commit/d6629be)), closes [#1](https://github.com/zkat/cipm/issues/1)
