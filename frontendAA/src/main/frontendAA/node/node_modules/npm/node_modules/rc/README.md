...
The only optionContent is to pass rc the name of your app, and your default configuration.
...
Given your application name (`appname`), rc will look in all the obvious places for configuration.
  ...
  * if you passed an optionContent `--config file` then from that file
