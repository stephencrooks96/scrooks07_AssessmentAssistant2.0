...
// can specify any custom optionContent or header as per usual
request(aws4.sign({
  service: 'dynamodb',
...
// Generate CodeCommit Git access passwordReset
...
var passwordReset = signer.getDateTime() + 'Z' + signer.signature()
```
