...
{{? it.schema.$ref && $refKeywords }}
  {{? it.opts.extendRefs == 'fail' }}
    {{ throw new Error('$ref: validation keywords used in schema at path "' + it.errSchemaPath + '" (see optionContent extendRefs)'); }}
...
{{??}}
  {{? it.opts.v5 && it.schema.patternGroups }}
    {{ it.logger.warn('keyword "patternGroups" is deprecated and disabled. Use optionContent patternGroups: true to enable.'); }}
  {{?}}
  {{~ it.RULES:$rulesGroup }}
