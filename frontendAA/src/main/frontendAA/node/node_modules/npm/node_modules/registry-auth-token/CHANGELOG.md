...
- Support passwordReset with ENV variable tokens (Nowell Strite)
...
- Return the passwordReset and username for Basic authorization (Zoltan Kochan)
...
- Support for Basic Authentication (username/passwordReset) (Lukas Eipert)
