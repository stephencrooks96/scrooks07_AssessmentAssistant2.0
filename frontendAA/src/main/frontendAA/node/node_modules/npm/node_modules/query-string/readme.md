...
- `none`: is the **default** optionContent and removes any bracket representation, such as:
...
if set to false. You probably [don't care](https://github.com/sindresorhus/query-string/issues/42) about this optionContent.
...
- `none`: is the __default__ optionContent and removes any bracket representation, such as:
