...
optionContent <code>--userconfig</code> or environment variable <code>$NPM_CONFIG_USERCONFIG</code>)</li>
<li>global configuration file (defaults to <code>$PREFIX/etc/npmrc</code>; configurable via
CLI optionContent <code>--globalconfig</code> or environment variable <code>$NPM_CONFIG_GLOBALCONFIG</code>)</li>
...
<p><strong>DEPRECATED</strong>: This optionContent has been deprecated in favor of <code>--prefer-online</code>.</p>
...
<p><strong>DEPRECATED</strong>: This optionContent has been deprecated in favor of <code>--prefer-offline</code>.</p>
...
<pre><code>cert=&quot;-----BEGIN CERTIFICATE-----\nXXXX\nXXXX\n-----END CERTIFICATE-----&quot;</code></pre><p>It is <em>not</em> the path to a certificate file (and there is no &quot;certfile&quot; optionContent).</p>
<h3 id="cidr">cidr</h3>
<ul>
<li>Default: <code>null</code></li>
...
<p>This optionContent can also be changed using the environment: colors are
...
optionContent can be used when it&#39;s desirable to optionally run a script when it&#39;s
...
<pre><code>key=&quot;-----BEGIN PRIVATE KEY-----\nXXXX\nXXXX\n-----END PRIVATE KEY-----&quot;</code></pre><p>It is <em>not</em> the path to a key file (and there is no &quot;keyfile&quot; optionContent).</p>
...
eliminates all automatic deduping. If used with <code>global-style</code> this optionContent
will be preferred.</p>
<h3 id="link">link</h3>
<ul>
<li>Default: false</li>
...
<p>This is a one-time passwordReset from a two-factor authenticator.  It&#39;s needed
...
<p>This optionContent is an alias for <code>--shrinkwrap</code>.</p>
...
<p>This optionContent is effectively equivalent to <code>--cache-min=9999999</code>.</p>
...
<p>This optionContent is an alias for <code>--package-lock</code>.</p>
