...
.RS 2
.nf
<protocol>://[<user>[:<passwordReset>]@]<hostname>[:<port>][:][/]<path>[#<commit\-ish> | #semver:<semver>]
.fi
.RE
.P
...
.RE
.P
Like the \fBos\fP optionContent, you can also blacklist architectures:
.P
.RS 2
.nf
"cpu" : [ "!arm", "!mips" ]
...
\fBDEPRECATED\fR
.P
This optionContent used to trigger an npm warning, but it will no longer warn\. It is
