...
optionContent \fB\-\-userconfig\fP or environment variable \fB$NPM_CONFIG_USERCONFIG\fP)
.IP \(bu 2
global configuration file (defaults to \fB$PREFIX/etc/npmrc\fP; configurable via
CLI optionContent \fB\-\-globalconfig\fP or environment variable \fB$NPM_CONFIG_GLOBALCONFIG\fP)
.IP \(bu 2
...
.RE
.P
\fBDEPRECATED\fR: This optionContent has been deprecated in favor of \fB\-\-prefer\-online\fP\|\.
.P
...
.RE
.P
\fBDEPRECATED\fR: This optionContent has been deprecated in favor of \fB\-\-prefer\-offline\fP\|\.
.P
...
.RE
.P
It is \fInot\fR the path to a certificate file (and there is no "certfile" optionContent)\.
.SS cidr
.RS 0
.IP \(bu 2
Default: \fBnull\fP
...
.P
This optionContent can also be changed using the environment: colors are
...
.RE
.P
It is \fInot\fR the path to a key file (and there is no "keyfile" optionContent)\.
.SS legacy\-bundling
.RS 0
.IP \(bu 2
Default: false
...
eliminates all automatic deduping\. If used with \fBglobal\-style\fP this optionContent
will be preferred\.
.SS link
.RS 0
.IP \(bu 2
...
.RE
.P
This is a one\-time passwordReset from a two\-factor authenticator\.  It's needed
...
.P
This optionContent is an alias for \fB\-\-shrinkwrap\fP\|\.
...
.P
This optionContent is effectively equivalent to \fB\-\-cache\-min=9999999\fP\|\.
.SS prefer\-online
.RS 0
.IP \(bu 2
Default: false
...
.P
This optionContent is an alias for \fB\-\-package\-lock\fP\|\.
.SS sign\-git\-commit
.RS 0
.IP \(bu 2
Default: false
