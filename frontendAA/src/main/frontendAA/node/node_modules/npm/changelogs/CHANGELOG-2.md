...
`maxsockets` optionContent to allow users to configure the number of concurrent sockets
...
* [`f961092`](https://github.com/npm/npm/commit/f9610920079d8b88ae464b30007a92c594bd85a8)
  ...
  Document the `--save-bundle` optionContent for `npm install`.
...
* [`14d72c7`](https://github.com/npm/npm/commit/14d72c756b89e2d167eb52c1849263dbddcb9f35)
  ...
  adds `--cafile` command line optionContent, and allows configuration of Node.js and
  io.js mirrors.
  ([@rvagg](https://github.com/rvagg))
...
* [`663a8c6`](https://github.com/npm/npm/commit/663a8c6b4b1647f9b86c15ef32e30023edc8c060)
  ...
  Update default value documentation for the color optionContent in npm's config.
...
So apparently the `preferGlobal` optionContent hasn't quite been warning correctly for
...
* [`cbde823`](https://github.com/npm/npm/commit/cbde8233436bf0ea62a4740869b4990322c20659)
  `init-package-json@1.9.1`: Add a `silent` optionContent to suppress output on writing the
...
* [`145af65`](https://github.com/npm/npm/commit/145af6587f45de135cc876be2027ed818ed4ca6a)
  ...
  `--node-gyp=/path/to/node-gyp` optionContent to npm. Swap in `pangyp` or a version
...
* [`2ef5771`](https://github.com/npm/npm/commit/2ef5771632006e6cee8cf17f836c0f98ab494bd1)
  ...
  configuration optionContent. ([@KenanY](https://github.com/KenanY))
...
* [`b4c717b`](https://github.com/npm/npm/commit/b4c717bbf58fb6a0d64ad229036c79a184297ee2)
  `npm-registry-client@3.1.4`: properly encode % in passwordResets
  ([@isaacs](https://github.com/isaacs))
