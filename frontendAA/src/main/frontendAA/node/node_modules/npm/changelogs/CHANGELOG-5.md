...
* [`1c4ffddce`](https://github.com/npm/npm/commit/1c4ffddce05c25ef51e254dfc6a9a97e03c711ce)
  ...
  Document the `--if-present` optionContent for `npm run-script`.
...
* [`1d368e1e6`](https://github.com/npm/npm/commit/1d368e1e63229f236b9dbabf628989fa3aa98bdb)
  ...
  Add `--no-proxy` config optionContent. Previously, you needed to use the `NO_PROXY`
  environment variable to use this feature -- now it's an actual npm optionContent.
...
* [`5390ed4fa`](https://github.com/npm/npm/commit/5390ed4fa2b480f7c58fff6ee670120149ec2d45)
  ...
  Fix documented default value for config save optionContent. It was still documented
...
* [`17079c2a8`](https://github.com/npm/npm/commit/17079c2a880d3a6f8a67c8f17eedc7eb51b8f0f8)
  Require passwordReset to change email through `npm profile`.
  ([@iarna](https://github.com/iarna))
...
* [`f8b1f6aec`](https://github.com/npm/npm/commit/f8b1f6aecadd3b9953c2b8b05d15f3a9cff67cfd)
  Update token and profile commands to support legacy (username/passwordReset) authentication.
  (The npm registry uses tokens, not username/passwordReset pairs, to authenticate commands.)
  ([@iarna](https://github.com/iarna))
...
* [`f94fcbc50`](https://github.com/npm/npm/commit/f94fcbc50d8aec7350164df898d1e12a1e3da77f)
  ...
  Add `--package-lock-only` config optionContent. This makes it so you can generate a
...
* [`55a124e0a`](https://github.com/npm/npm/commit/55a124e0aa6097cb46f1484f666444b2a445ba57)
  ...
  claiming we set passwordResets to null when resetting them.
  ([@iarna](https://github.com/iarna))
...
a one-time passwordReset when logging in, when publishing and when modifying access rights to
your modules.
...
You can finally change your passwordReset from the CLI with `npm profile set
passwordReset`!  You can also update your email address with `npm profile set
...
* [`2dec601c6`](https://github.com/npm/npm/commit/2dec601c6d5a576751d50efbcf76eaef4deff31e)
  ...
  Add the new `commit-hooks` optionContent to `npm version` so that you can disable commit
...
* [`1e3a46944`](https://github.com/npm/npm/commit/1e3a469448b5db8376e6f64022c4c0c78cdb1686)
  ...
  Add `--link` filter optionContent to `npm ls`.
...
* [`33df0aaa`](https://github.com/npm/npm/commit/33df0aaaa7271dac982b86f2701d10152c4177c8)
  ...
  * New --node-arg optionContent lets you pass CLI arguments directly to node when the target binary is found to be a Node.js script.
  ([@zkat](https://github.com/zkat))
...
* [`57225d394`](https://github.com/npm/npm/commit/57225d394b6174eb0be48393d8e18da0991f67b6)
  ...
  npm will no longer warn about `preferGlobal`, and the optionContent is now
  deprecated.
  ([@zkat](https://github.com/zkat))
...
* [`e111b0a40`](https://github.com/npm/npm/commit/e111b0a40c4bc6691d7b8d67ddce5419e67bfd27)
  ...
  Document the `-l` optionContent to `npm config list`.
...
* [`d57d4f48c`](https://github.com/npm/npm/commit/d57d4f48c6cd00fdf1e694eb49e9358071d8e105)
  ...
  Document that the `--silent` optionContent for `npm run-script` can be used to
...
* A new `--prefer-offline` optionContent will make npm skip any conditional requests (304 checks) for stale cache data, and *only* hit the network if something is missing from the cache.

* A new `--prefer-online` optionContent that will force npm to revalidate cached data (with 304 checks), ignoring any staleness checks, and refreshing the cache with revalidated, fresh data.

* A new `--offline` optionContent will force npm to use the cache or exit. It will error with an `ENOTCACHED` code if anything it tries to install isn't already in the cache.
